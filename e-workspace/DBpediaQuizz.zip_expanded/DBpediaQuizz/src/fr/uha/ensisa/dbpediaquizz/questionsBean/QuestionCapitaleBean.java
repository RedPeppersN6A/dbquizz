...
public class QuestionCapitaleBean extends QuestionBean {

	public QuestionCapitaleBean()
	{
		...
		if(Math.random()<0.5)
		{
			...
			this.enonce = new SimpleStringProperty("Quelle est la capitale de "+ligne.getLiteral("?nomPays").getString()+" ?");
		...
		else
		{
			...
			this.enonce = new SimpleStringProperty("De quoi "+ligne.getLiteral("?nomVille").getString()+" est la capitale ?");
