...
public class QuestionFiction extends Question {
	
	public QuestionFiction()
	{
		...
		QuerySolution ligne = chanteurs.get((int)(Math.random()*chanteurs.size()));
			...
			this.enonce = "Quel est l'épèce de ce personnage de fiction : "+ligne.getLiteral("?nompf").getString()+" ?";
