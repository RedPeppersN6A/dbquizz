...
public class QuestionChampionnatFranceFootballBean extends QuestionBean {

	public QuestionChampionnatFranceFootballBean()
	{
		...
		QuerySolution ligne = chamionnats.get((int)(Math.random()*chamionnats.size()));
			...
			this.enonce = new SimpleStringProperty("Quelle équipe a gagné le "+ligne.getLiteral("?nomTournoi").getString()+" ?");
